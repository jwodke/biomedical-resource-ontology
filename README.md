...
Version 5.0.0: We curated the child classes further and updated all class 
definitions. We incremented the major version due to the change from literal 
URIs to an alphanumerical system.
